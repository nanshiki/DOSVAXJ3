...
#define BIOS_NROWS Bit16u nrows=(IS_EGAVGA_ARCH||IS_J3_ARCH)?((Bit16u)real_readb(BIOSMEM_SEG,BIOSMEM_NB_ROWS)+1):25;
#define BIOS_CHEIGHT Bit8u cheight=(IS_EGAVGA_ARCH||IS_J3_ARCH)?real_readb(BIOSMEM_SEG,BIOSMEM_CHAR_HEIGHT):8;
...
typedef struct {
	...
	bool vesa_nolfb;
	bool vesa_oldvbe;
//	bool set_axbios_enabled;//for AX
	Bit8u text_row;
	Bit8u vtext_svga;
} Int10Data;
