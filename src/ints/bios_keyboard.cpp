...
static scancode_tbl scan_specialkey[3]{
	{ 0xa700, 0xa800, 0xa900, 0xaa00, 0xa700, 0xa800 }, /* Conv */
	{ 0xab00, 0xac00, 0xad00, 0xae00, 0xab00, 0xac00 },  /* noconv */
	{ 0xd200, 0xd300, 0xd400, 0xd500, 0xd200, 0xd300 }  /* AX */
};
	
static scancode_tbl scan_to_scanascii[MAX_SCAN_CODE + 1] = {
	  { none,   none,   none,   none,   none,   none },
	  { 0x011b, 0x011b, 0x011b, 0x01f0 ,0x011b, 0x011b }, /* escape */
	  { 0x0231, 0x0221,   none, 0x7800 ,0x02c7, 0x02c7 }, /* 1! */
	  { 0x0332, 0x0340, 0x0300, 0x7900 ,0x03cc, 0x03cc }, /* 2@ */
	  { 0x0433, 0x0423,   none, 0x7a00 ,0x04b1, 0x04a7 }, /* 3# */
	  { 0x0534, 0x0524,   none, 0x7b00 ,0x05b3, 0x05a9 }, /* 4$ */
	  { 0x0635, 0x0625,   none, 0x7c00 ,0x06b4, 0x06aa }, /* 5% */
	  { 0x0736, 0x075e, 0x071e, 0x7d00 ,0x07b5, 0x07ab }, /* 6^ */
	  { 0x0837, 0x0826,   none, 0x7e00 ,0x08d4, 0x08ac }, /* 7& */
	  { 0x0938, 0x092a,   none, 0x7f00 ,0x09d5, 0x09ad }, /* 8* */
	  { 0x0a39, 0x0a28,   none, 0x8000 ,0x0ad6, 0x0aae }, /* 9( */
	  { 0x0b30, 0x0b29,   none, 0x8100 ,0x0bdc, 0x0ba6 }, /* 0) */
	  { 0x0c2d, 0x0c5f, 0x0c1f, 0x8200 ,0x0cce, 0x0cce }, /* -_ */
	  { 0x0d3d, 0x0d2b,   none, 0x8300 ,0x0dcd, 0x0dcd }, /* =+ */
	  { 0x0e08, 0x0e08, 0x0e7f, 0x0ef0 ,0x0e08, 0x0e08 }, /* backspace */
	  { 0x0f09, 0x0f00, 0x9400,   none ,0x0f09, 0x0f00 }, /* tab */
	  { 0x1071, 0x1051, 0x1011, 0x1000 ,0x10c0, 0x10c0 }, /* Q */
	  { 0x1177, 0x1157, 0x1117, 0x1100 ,0x11c3, 0x11c3 }, /* W */
	  { 0x1265, 0x1245, 0x1205, 0x1200 ,0x12b2, 0x12a8 }, /* E */
	  { 0x1372, 0x1352, 0x1312, 0x1300 ,0x13bd, 0x13bd }, /* R */
	  { 0x1474, 0x1454, 0x1414, 0x1400 ,0x14b6, 0x14b6 }, /* T */
	  { 0x1579, 0x1559, 0x1519, 0x1500 ,0x15dd, 0x15dd }, /* Y */
	  { 0x1675, 0x1655, 0x1615, 0x1600 ,0x16c5, 0x16c5 }, /* U */
	  { 0x1769, 0x1749, 0x1709, 0x1700 ,0x17c6, 0x17c6 }, /* I */
	  { 0x186f, 0x184f, 0x180f, 0x1800 ,0x18d7, 0x18d7 }, /* O */
	  { 0x1970, 0x1950, 0x1910, 0x1900 ,0x19be, 0x19be }, /* P */
	  { 0x1a5b, 0x1a7b, 0x1a1b, 0x1af0 ,0x1ade, 0x1ade }, /* [{ */
	  { 0x1b5d, 0x1b7d, 0x1b1d, 0x1bf0 ,0x1bdf, 0x1ba2 }, /* ]} */
	  { 0x1c0d, 0x1c0d, 0x1c0a,   none ,0x1c0d, 0x1c0d }, /* Enter */
	  { none,   none,   none,   none ,   none,   none }, /* L Ctrl */
	  { 0x1e61, 0x1e41, 0x1e01, 0x1e00 ,0x1ec1, 0x1ec1 }, /* A */
	  { 0x1f73, 0x1f53, 0x1f13, 0x1f00 ,0x1fc4, 0x1fc4 }, /* S */
	  { 0x2064, 0x2044, 0x2004, 0x2000 ,0x20bc, 0x20bc }, /* D */
	  { 0x2166, 0x2146, 0x2106, 0x2100 ,0x21ca, 0x21ca }, /* F */
	  { 0x2267, 0x2247, 0x2207, 0x2200 ,0x22b7, 0x22b7 }, /* G */
	  { 0x2368, 0x2348, 0x2308, 0x2300 ,0x23b8, 0x23b8 }, /* H */
	  { 0x246a, 0x244a, 0x240a, 0x2400 ,0x24cf, 0x24cf }, /* J */
	  { 0x256b, 0x254b, 0x250b, 0x2500 ,0x25c9, 0x25c9 }, /* K */
	  { 0x266c, 0x264c, 0x260c, 0x2600 ,0x26d8, 0x26d8 }, /* L */
	  { 0x273b, 0x273a,   none, 0x27f0 ,0x27da, 0x27da }, /* ;: */
	  { 0x2827, 0x2822,   none, 0x28f0 ,0x28b9, 0x28b9 }, /* '" */
	  { 0x2960, 0x297e,   none, 0x29f0 ,0x29d1, 0x29a3 }, /* `~ */
	  { none,   none,   none,   none ,   none,   none }, /* L shift */
	  { 0x2b5c, 0x2b7c, 0x2b1c, 0x2bf0 ,0x2bb0, 0x2bb0 }, /* |\ */
	  { 0x2c7a, 0x2c5a, 0x2c1a, 0x2c00 ,0x2cc2, 0x2caf }, /* Z */
	  { 0x2d78, 0x2d58, 0x2d18, 0x2d00 ,0x2dbb, 0x2dbb }, /* X */
	  { 0x2e63, 0x2e43, 0x2e03, 0x2e00 ,0x2ebf, 0x2ebf }, /* C */
	  { 0x2f76, 0x2f56, 0x2f16, 0x2f00 ,0x2fcb, 0x2fcb }, /* V */
	  { 0x3062, 0x3042, 0x3002, 0x3000 ,0x30ba, 0x30ba }, /* B */
	  { 0x316e, 0x314e, 0x310e, 0x3100 ,0x31d0, 0x31d0 }, /* N */
	  { 0x326d, 0x324d, 0x320d, 0x3200 ,0x32d3, 0x32d3 }, /* M */
	  { 0x332c, 0x333c,   none, 0x33f0 ,0x33c8, 0x33a4 }, /* ,< */
	  { 0x342e, 0x343e,   none, 0x34f0 ,0x34d9, 0x34a1 }, /* .> */
	  { 0x352f, 0x353f,   none, 0x35f0 ,0x35d2, 0x35a5 }, /* /? */
	  { none,   none,   none,   none ,   none,   none }, /* R Shift */
	  { 0x372a, 0x372a, 0x9600, 0x37f0 , 0x372a, 0x372a }, /* * */
	  { none,   none,   none,   none ,   none,   none }, /* L Alt */
	  { 0x3920, 0x3920, 0x3920, 0x3920 , 0x3920, 0x3920 }, /* space */
//	  { none,   none,   none,   none ,   none,   none }, /* caps lock */
	  { 0x3a00, 0x3a00,   none,   none , 0x3a00, 0x3a00 }, /* Kanji */
	  { 0x3b00, 0x5400, 0x5e00, 0x6800 ,0x3b00, 0x5400 }, /* F1 */
	  { 0x3c00, 0x5500, 0x5f00, 0x6900 ,0x3c00, 0x5500 }, /* F2 */
	  { 0x3d00, 0x5600, 0x6000, 0x6a00 ,0x3d00, 0x5600 }, /* F3 */
	  { 0x3e00, 0x5700, 0x6100, 0x6b00 ,0x3e00, 0x5700 }, /* F4 */
	  { 0x3f00, 0x5800, 0x6200, 0x6c00 ,0x3f00, 0x5800 }, /* F5 */
	  { 0x4000, 0x5900, 0x6300, 0x6d00 ,0x4000, 0x5900 }, /* F6 */
	  { 0x4100, 0x5a00, 0x6400, 0x6e00 ,0x4100, 0x5a00 }, /* F7 */
	  { 0x4200, 0x5b00, 0x6500, 0x6f00 ,0x4200, 0x5b00 }, /* F8 */
	  { 0x4300, 0x5c00, 0x6600, 0x7000 ,0x4300, 0x5c00 }, /* F9 */
	  { 0x4400, 0x5d00, 0x6700, 0x7100 ,0x4400, 0x5d00 }, /* F10 */
	  { none,   none,   none,   none ,   none,   none }, /* Num Lock */
	  { none,   none,   none,   none ,   none,   none }, /* Scroll Lock */
	  { 0x4700, 0x4737, 0x7700, 0x0007 ,0x4737, 0x4737 }, /* 7 Home */
	  { 0x4800, 0x4838, 0x8d00, 0x0008 ,0x4838, 0x4838 }, /* 8 UP */
	  { 0x4900, 0x4939, 0x8400, 0x0009 ,0x4939, 0x4939 }, /* 9 PgUp */
	  { 0x4a2d, 0x4a2d, 0x8e00, 0x4af0 ,0x4a2d, 0x4a2d }, /* - */
	  { 0x4b00, 0x4b34, 0x7300, 0x0004 ,0x4b34, 0x4b34 }, /* 4 Left */
	  { 0x4cf0, 0x4c35, 0x8f00, 0x0005 ,0x4c35, 0x4c35 }, /* 5 */
	  { 0x4d00, 0x4d36, 0x7400, 0x0006 ,0x4d36, 0x4d36 }, /* 6 Right */
	  { 0x4e2b, 0x4e2b, 0x9000, 0x4ef0 ,0x4e2b, 0x4e2b }, /* + */
	  { 0x4f00, 0x4f31, 0x7500, 0x0001 ,0x4f31, 0x4f31 }, /* 1 End */
	  { 0x5000, 0x5032, 0x9100, 0x0002 ,0x5032, 0x5032 }, /* 2 Down */
	  { 0x5100, 0x5133, 0x7600, 0x0003 ,0x5133, 0x5133 }, /* 3 PgDn */
	  { 0x5200, 0x5230, 0x9200, 0x0000 ,0x5230, 0x5230 }, /* 0 Ins */
	  { 0x5300, 0x532e, 0x9300,   none ,0x532e, 0x532e }, /* Del */
	  { none,   none,   none,   none ,   none,   none },
	  { none,   none,   none,   none ,   none,   none },
	  { 0x565c, 0x567c,   none,   none ,0x565c, 0x567c }, /* (102-key) */
	  { 0x8500, 0x8700, 0x8900, 0x8b00 ,0x8500, 0x8700 }, /* F11 */
	  { 0x8600, 0x8800, 0x8a00, 0x8c00 ,0x8600, 0x8800 }  /* F12 */
      };
...
//	case 0xd2:	
	...
	case 0xd2:
	{
		//this code is not smart...
		Bit16u asciiscan;
		Bitu idx = 0;
		if (scancode == 0xa7) idx = 0;
		else if (scancode == 0xab) idx = 1;
		else if (scancode == 0xd2) idx = 2;
		if (flags1 & 0x08) { 					/* Alt is being pressed */
			asciiscan = scan_to_scanascii[idx].alt;
		}
		else if (flags1 & 0x04) {					/* Ctrl is being pressed */
			asciiscan = scan_to_scanascii[idx].control;
		}
		else if ((flags1 & 0x03) && (kanafl & 0x02)) {
			asciiscan = scan_to_scanascii[idx].kana_shift; //for AX
		}
		else if (flags1 & 0x03) {					/* Either shift is being pressed */
			asciiscan = scan_to_scanascii[idx].shift;
		}
		else if (kanafl & 0x02) {
			asciiscan = scan_to_scanascii[idx].kana; //for AX
		}
		else {
			asciiscan = scan_to_scanascii[idx].normal;
		}
		break;
	}
	case 0x47:		/* Numpad */
...
normal_key:
		...
		if (flags1 & 0x08) { 					/* Alt is being pressed */
			...
			asciiscan = scan_to_scanascii[scancode].kana; //for AX
		}
		else {
