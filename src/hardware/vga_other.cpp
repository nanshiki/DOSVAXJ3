...
void VGA_SetupOther(void) {
	...
	if (machine==MCH_CGA || IS_TANDY_ARCH || machine==MCH_DCGA) {
	...
	if (machine==MCH_CGA || IS_TANDY_ARCH || machine==MCH_HERC || machine==MCH_DCGA) {
	...
	if (machine==MCH_CGA || machine==MCH_DCGA) {
