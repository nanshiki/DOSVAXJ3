...
/*	case CB_IPXESR:		// IPX ESR
	...
	case CB_INT6F_ATOK:
		...
		phys_writeb(physAddress+0x03,(Bit8u)'A');		//An IRET Instruction
		phys_writeb(physAddress+0x04,(Bit8u)'T');		//An IRET Instruction
		phys_writeb(physAddress+0x05,(Bit8u)'O');		//An IRET Instruction
		phys_writeb(physAddress+0x06,(Bit8u)'K');		//An IRET Instruction
		if (use_cb) {
