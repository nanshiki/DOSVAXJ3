...
正しました。
　Windows 版で mount されたドライブ上のファイルを読み込みモードで開いた場合でも
日時変更可能となるよう修正しました。
　Linux、macOS 版でショートファイル名の生成がうまくいっていなかったのを修正しま
した。
...
　int 21h ax=714eh, 714fh で 2 バイト余計にバッファに書き込みしていたのを修正し
ました。
　int 21h ax=714eh, 714fh, 71a6h で返されるファイル情報の日時等の値が間違ってい
たのを修正しました。
